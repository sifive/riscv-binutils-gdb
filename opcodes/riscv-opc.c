...
{"call",        0, INSN_CLASS_ZICFILP, "d,c", (X_T2 << OP_SH_RS1), (int) M_CALL, match_never, INSN_MACRO },
...
{"tail",        0, INSN_CLASS_ZICFILP, "c",   (X_T2 << OP_SH_RS1), (int) M_CALL, match_never, INSN_MACRO },
