...
[ 	]+[0-9a-f]+:[ 	]+fc050073[ 	]+sf.cflush.d.l1[ 	]+a0
[ 	]+[0-9a-f]+:[ 	]+fc250073[ 	]+sf.cdiscard.d.l1[ 	]+a0
...
[ 	]+[0-9a-f]+:[ 	]+4c531157[ 	]+sf.vfexpa.v[ 	]+v2,v5,v0.t
[ 	]+[0-9a-f]+:[ 	]+4c531157[ 	]+sf.vfexpa.v[ 	]+v2,v5,v0.t
[ 	]+[0-9a-f]+:[ 	]+4c539157[ 	]+sf.vfexp.v[ 	]+v2,v5,v0.t
[ 	]+[0-9a-f]+:[ 	]+4e539157[ 	]+sf.vfexp.v[ 	]+v2,v5
[ 	]+[0-9a-f]+:[ 	]+4c539157[ 	]+sf.vfexp.v[ 	]+v2,v5,v0.t
[ 	]+[0-9a-f]+:[ 	]+4e539157[ 	]+sf.vfexp.v[ 	]+v2,v5
[ 	]+[0-9a-f]+:[ 	]+4c539157[ 	]+sf.vfexp.v[ 	]+v2,v5,v0.t
[ 	]+[0-9a-f]+:[ 	]+4e539157[ 	]+sf.vfexp.v[ 	]+v2,v5
[ 	]+[0-9a-f]+:[ 	]+1c05f557[ 	]+vsetvli[ 	]+a0,a1,e8alt,m1,ta,ma
...
[ 	]+[0-9a-f]+:[ 	]+00c5857b[ 	]+sf.sci.3.r[ 	]+0x0,0x0,a0,a1,a2
[ 	]+[0-9a-f]+:[ 	]+fec5e57b[ 	]+sf.sci.3.r[ 	]+0x6,0x7f,a0,a1,a2
...
[ 	]+[0-9a-f]+:[ 	]+5ac5b52b[ 	]+sf.sci.1.r[ 	]+0x3,0x2d,a0,a1,a2
[ 	]+[0-9a-f]+:[ 	]+14c5c55b[ 	]+sf.sci.2.r[ 	]+0x4,0xa,a0,a1,a2
[ 	]+[0-9a-f]+:[ 	]+aec5d55b[ 	]+sf.sci.2.r[ 	]+0x5,0x57,a0,a1,a2
[ 	]+[0-9a-f]+:[ 	]+00c5857b[ 	]+sf.sci.3.r[ 	]+0x0,0x0,a0,a1,a2
[ 	]+[0-9a-f]+:[ 	]+fec5e57b[ 	]+sf.sci.3.r[ 	]+0x6,0x7f,a0,a1,a2
[ 	]+[0-9a-f]+:[ 	]+4d26860b[ 	]+sf.sci.0.r[ 	]+0x0,0x26,a2,a3,s2
[ 	]+[0-9a-f]+:[ 	]+800716ab[ 	]+sf.sci.1.r[ 	]+0x1,0x40,a3,a4,zero
[ 	]+[0-9a-f]+:[ 	]+7ff7a75b[ 	]+sf.sci.2.r[ 	]+0x2,0x3f,a4,a5,t6
[ 	]+[0-9a-f]+:[ 	]+fff837fb[ 	]+sf.sci.3.r[ 	]+0x3,0x7f,a5,a6,t6
[ 	]+[0-9a-f]+:[ 	]+fffff60b[ 	]+sf.sci.0.r[ 	]+0x7,0x7f,a2,t6,t6
[ 	]+[0-9a-f]+:[ 	]+000006ab[ 	]+sf.sci.1.r[ 	]+0x0,0x0,a3,zero,zero
[ 	]+[0-9a-f]+:[ 	]+1e24075b[ 	]+sf.sci.2.r[ 	]+0x0,0xf,a4,s0,sp
[ 	]+[0-9a-f]+:[ 	]+00fff7fb[ 	]+sf.sci.3.r[ 	]+0x7,0x0,a5,t6,a5
[ 	]+[0-9a-f]+:[ 	]+ffffff8b[ 	]+sf.sci.0.r[ 	]+0x7,0x7f,t6,t6,t6
[ 	]+[0-9a-f]+:[ 	]+0000002b[ 	]+sf.sci.1.r[ 	]+0x0,0x0,zero,zero,zero
[ 	]+[0-9a-f]+:[ 	]+00f1205b[ 	]+sf.sci.2.r[ 	]+0x2,0x0,zero,sp,a5
[ 	]+[0-9a-f]+:[ 	]+0007fffb[ 	]+sf.sci.3.r[ 	]+0x7,0x0,t6,a5,zero
