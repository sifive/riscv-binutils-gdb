...
START_RELOC_NUMBERS (elf_riscv_reloc_type)
  ...
  RELOC_NUMBER (R_RISCV_SIFIVE_GPREL_HI20, 194)
  RELOC_NUMBER (R_RISCV_SIFIVE_GPREL_LO12_I, 195)
  RELOC_NUMBER (R_RISCV_SIFIVE_GPREL_LO12_S, 196)
  RELOC_NUMBER (R_RISCV_SIFIVE_GPREL_ADD, 197)
  RELOC_NUMBER (R_RISCV_SIFIVE_GPREL_LOAD, 198)
  RELOC_NUMBER (R_RISCV_SIFIVE_GPREL_STORE, 199)
  RELOC_NUMBER (R_RISCV_SIFIVE_GOT_GPREL_HI20, 200)
  RELOC_NUMBER (R_RISCV_SIFIVE_GOT_GPREL_LO12_I, 201)
  RELOC_NUMBER (R_RISCV_SIFIVE_GOT_GPREL_ADD, 202)
  RELOC_NUMBER (R_RISCV_SIFIVE_GOT_GPREL_LOAD, 203)
  RELOC_NUMBER (R_RISCV_SIFIVE_GOT_GPREL_STORE, 204)
  RELOC_NUMBER (R_RISCV_SIFIVE_TLS_GOT_GPREL_HI20, 205)
  RELOC_NUMBER (R_RISCV_SIFIVE_TLS_GOT_GPREL_LO12_I, 206)
  RELOC_NUMBER (R_RISCV_SIFIVE_TLS_GOT_GPREL_ADD, 207)
  RELOC_NUMBER (R_RISCV_SIFIVE_TLS_GD_GPREL_HI20, 208)
  RELOC_NUMBER (R_RISCV_SIFIVE_TLS_GD_GPREL_LO12_I, 209)
  RELOC_NUMBER (R_RISCV_SIFIVE_TLS_GD_GPREL_ADD, 210)
  RELOC_NUMBER (R_RISCV_SIFIVE_64_PCREL, 211)
