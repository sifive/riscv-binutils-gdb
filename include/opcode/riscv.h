...
enum riscv_insn_class
{
  ...
  INSN_CLASS_ZVFBFMIN,
  INSN_CLASS_ZVQDOTQ,
  INSN_CLASS_ZVQBDOT8I_OR_ZVQBDOT16I,
  INSN_CLASS_ZVFWBDOT16BF,
  INSN_CLASS_ZVFQBDOT8F,
  INSN_CLASS_ZVFBDOT32F,

  INSN_CLASS_ZVFBFWMA,
  INSN_CLASS_ZVFOFP8MIN,
  INSN_CLASS_ZVFBFMIN_OR_ZVFOFP8MIN,
  INSN_CLASS_ZVFOFP4MIN,
  INSN_CLASS_ZVKB,
  INSN_CLASS_ZVKG,
  INSN_CLASS_ZVKNED,
